...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.elmahdi43.hsab.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.elmahdi43.hsab.security.DomainUserDetailsService", "createSpringSecurityUser");
